...
public static void main(String[] args) {
	...
	graph.insertEdge(new Edge(0, 4, 1));
	graph.insertEdge(new Edge(0, 1, 2));
	graph.insertEdge(new Edge(0, 2, 2));
	graph.insertEdge(new Edge(0, 3, 2));
	graph.insertEdge(new Edge(2, 5, 2));
	graph.BFStraverse();
	graph.DFStraverse() ;
	graph.Dijkstra();
...
class Edge {
	...
	int dest ;
	int weight;
	public Edge(int minstart, int mindest, int i) {
